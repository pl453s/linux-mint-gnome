...
var FileItem = class {
    ...
    _createMenu() {
        ...
        this._menu.add(new Gtk.SeparatorMenuItem());
        let properties = new Gtk.MenuItem({label: this._selectedItemsNum > 1 ? _('Properties') : _('Properties') });
        properties.connect('activate', () => this._onPropertiesClicked());
        this._menu.add(properties);
        this._menu.add(new Gtk.SeparatorMenuItem());
        let showInFiles = new Gtk.MenuItem({label: this._selectedItemsNum > 1 ? _('Show in Files') : _('Show in Files')});
