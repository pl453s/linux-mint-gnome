...
- This a the big project, create a central GUI to customize (for now, it's just a Zenity info box which launch 'Gnome Tweaks'):  
...
Of course, do not enable 'Dash to Panel' and 'Dash to Dock' at the same time!
